...
<main>
    ...
    <div class="banner-text-left lernen_banner large bg-about">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-5">
                        <div class="section-title with-p">
                            <span class="bg-start-light">FAQs</span>
    ...
    <div id="why-us" class="wrap-bg-dark">
        <div class="row">
            ...
            <div class="width400">
                ...
                <div id="accordion2" class="accordion-light">
                    <div class="card">
                        <div class="card-header" id="headingOne2">
                            <div class="mb-0">
                                <div class="btn btn-link" role="button" data-toggle="collapse" data-target="#collapseOne2" aria-expanded="true" aria-controls="collapseOne2">
                                    Collapsible Group Item #1
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header" id="headingTwo2">
                            <div class="mb-0">
                                <div class="btn btn-link collapsed" role="button" data-toggle="collapse" data-target="#collapseTwo2" aria-expanded="false" aria-controls="collapseTwo2">
                                    Collapsible Group Item #2
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header" id="headingThree2">
                            <div class="mb-0">
                                <div class="btn btn-link collapsed" role="button" data-toggle="collapse" data-target="#collapseThree2" aria-expanded="false" aria-controls="collapseThree2">
                                    Collapsible Group Item #3
                                </div>
                            </div>
                        </div>
